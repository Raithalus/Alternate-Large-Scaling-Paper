...
BcdFiles = dir('C:\Users\che7oz\Desktop\w1118 2493 9312 Hb\Line 2493\*_c4.jpg');
HbFiles = dir('C:\Users\che7oz\Desktop\w1118 2493 9312 Hb\Line 2493\*_c4.jpg'); 
DapiFiles = dir('C:\Users\che7oz\Desktop\w1118 2493 9312 Hb\Line 2493\*_c3.jpg');
...
%     figure,imshow(W);
    ...
    theta2=0 %180*double(max(max(BcdI1(:,1:50)))<max(max(BcdI1(:,max(m0)-min(m0)-48:max(m0)-min(m0)+1)))); % Anterior-posterior
