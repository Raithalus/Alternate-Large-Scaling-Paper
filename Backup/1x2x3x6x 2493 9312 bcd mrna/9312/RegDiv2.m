...
ProbeFiles = dir('C:\Users\che7oz\Desktop\1x2x3x6x 2493 9312 bcd mrna\9312\*_c4.jpg');
for i=1:length(ProbeFiles)
ProbeI=imread(ProbeFiles(i).name);
ProbeI=ProbeI(:,:,1);
DapiFiles = dir('C:\Users\che7oz\Desktop\1x2x3x6x 2493 9312 bcd mrna\9312\*_c3.jpg');
